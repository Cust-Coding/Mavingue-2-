  ...
  ADMIN: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Regras de cobranca", href: "/admin/agua/regras-cobranca", permissions: ["water.billing-rules.manage"] },
    ...
    },
    {
      ...
      label: "Estatistica",
      items: [
        { label: "Centro de estatistica", href: "/admin/relatorios", permissions: ["reports.view"] },
        { label: "Dashboard geral", href: "/admin" },
        ...
        { label: "Estado do sistema", href: "/admin/relatorios/estado-sistema", permissions: ["reports.system-status.view"] },
        { label: "Agua", href: "/admin/relatorios/agua", permissions: ["reports.water.view"] },
        { label: "Clientes", href: "/admin/clientes", permissions: ["customers.view"] },
        { label: "Utilizadores", href: "/admin/utilizadores", permissions: ["users.view"] },
        { label: "Produtos", href: "/admin/produtos", permissions: ["products.view"] },
        { label: "Categorias", href: "/admin/categorias", permissions: ["categories.manage"] },
        { label: "Compras", href: "/admin/compras", permissions: ["purchases.view"] },
  ...
  FUNCIONARIO: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Ferragem", href: "/staff/ferragem", permissions: ["ferragem.view"] },
      ],
    },
    {
      id: "comercial",
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Regras de cobranca", href: "/staff/agua/regras-cobranca", permissions: ["water.billing-rules.manage"] },
    ...
    },
    {
      ...
      label: "Estatistica",
      items: [
        { label: "Centro de estatistica", href: "/staff/relatorios", permissions: ["reports.view"] },
        { label: "Dashboard geral", href: "/staff" },
        ...
        { label: "Estado do sistema", href: "/staff/relatorios/estado-sistema", permissions: ["reports.system-status.view"] },
        { label: "Agua", href: "/staff/relatorios/agua", permissions: ["reports.water.view"] },
        { label: "Clientes", href: "/staff/clientes", permissions: ["customers.view"] },
        { label: "Utilizadores", href: "/staff/utilizadores", permissions: ["users.view"] },
        { label: "Produtos", href: "/staff/produtos", permissions: ["products.view"] },
        { label: "Categorias", href: "/staff/categorias", permissions: ["categories.manage"] },
        { label: "Compras", href: "/staff/compras", permissions: ["purchases.view"] },
