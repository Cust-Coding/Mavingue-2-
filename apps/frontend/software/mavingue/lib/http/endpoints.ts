export const endpoints = {
  ...
  stockMovements: "/api/stock/movimentos",
  ...
  customerWaterActivate: (id: number) => `/api/customer-water/${id}/activar`,
  customerWaterApprove: (id: number) => `/api/customer-water/${id}/aprovar`,
  customerWaterReject: (id: number) => `/api/customer-water/${id}/rejeitar`,
  waterBillingRules: "/api/regras-cobranca-agua",
  waterBillingRuleCurrent: "/api/regras-cobranca-agua/actual",
  ...
  facturaAguaAplicarMulta: "/api/facturas-agua/aplicar-multa",

  clientArea: {
    profile: "/api/client-area/profile",
    deactivateAccount: "/api/client-area/profile/account",
    compras: "/api/client-area/compras",
    checkout: "/api/client-area/compras/checkout",
    ...
    aguaSolicitacoes: "/api/client-area/agua/solicitacoes",
    aguaSolicitacaoById: (id: number) => `/api/client-area/agua/solicitacoes/${id}`,
    aguaSolicitacao: "/api/client-area/agua/solicitacao",
